...
plt.figure(figsize=(9,9), dpi=80, facecolor=(1, 1, 1))
Q = plt.quiver(outLine_force_z, outLine_force_y)
...
plt.title(r'Total radiation force on each dipole for a sphere(YZ-plane)')
